...
bool SwigDirector_ClientAPI_OpenVPNClient::socket_protect(int socket) {
  bool c_result = SwigValueInit< bool >() ;
  jboolean jresult = 0 ;
  JNIEnvWrapper swigjnienv(this) ;
  JNIEnv * jenv = swigjnienv.getJNIEnv() ;
  ...
  if (swigjobj && jenv->IsSameObject(swigjobj, NULL) == JNI_FALSE) {
    jsocket = (jint) socket;
    jresult = (jboolean) jenv->CallStaticBooleanMethod(Swig::jclass_ovpncliJNI, Swig::director_method_ids[24], swigjobj, jsocket);
    jthrowable swigerror = jenv->ExceptionOccurred();
    if (swigerror) {
      jenv->ExceptionClear();
      throw Swig::DirectorException(jenv, swigerror);
...
SWIGEXPORT jboolean JNICALL Java_net_openvpn_ovpn3_ovpncliJNI_ClientAPI_1ExternalPKIBase_1sign(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jstring jarg2, jlong jarg3) {
  jboolean jresult = 0 ;
  ...
  result = (bool)(arg1)->sign((std::string const &)*arg2,*arg3);
  jresult = (jboolean)result; 
  return jresult;
}
...
SWIGEXPORT jboolean JNICALL Java_net_openvpn_ovpn3_ovpncliJNI_ClientAPI_1OpenVPNClient_1socket_1protect(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2) {
  jboolean jresult = 0 ;
  openvpn::ClientAPI::OpenVPNClient *arg1 = (openvpn::ClientAPI::OpenVPNClient *) 0 ;
  int arg2 ;
  bool result;
  ...
  arg1 = *(openvpn::ClientAPI::OpenVPNClient **)&jarg1; 
  arg2 = (int)jarg2; 
  result = (bool)(arg1)->socket_protect(arg2);
  jresult = (jboolean)result; 
  return jresult;
}
...
SWIGEXPORT void JNICALL Java_net_openvpn_ovpn3_ovpncliJNI_swig_1module_1init(JNIEnv *jenv, jclass jcls) {
  ...
  static struct {
    ...
    {
      "SwigDirector_ClientAPI_OpenVPNClient_socket_protect", "(Lnet/openvpn/ovpn3/ClientAPI_OpenVPNClient;I)Z" 
    },
    {
