...
public class AppActivity extends Activity implements OnClickListener, StateListener, ByteCountListener, LogListener {
    ...
    public static String SHORTCUT_CONNECT = "com.proxysh.shieldtra.SHORTCUT_CONNECT";
    public static String SHORTCUT_DISCONNECT = "com.proxysh.shieldtra.SHORTCUT_DISCONNECT";
    ...
    private Button tabBtnConnect, tabBtnDisconnect, tabBtnSetting, tabBtnShieldtra, tabBtnLogs, tabBtnPanel;
    ...
    private void initialize() {
        ...
        tabBtnShieldtra = (Button) findViewById(R.id.tabBtnShieldtra);
        ...
        tabBtnShieldtra.setOnClickListener(this);
    ...
    private void setEnabledButtonBar(boolean enabled) {
        ...
        tabBtnShieldtra.setEnabled(enabled);
        ...
        if (!enabled) {
            ...
            tabBtnShieldtra.setSelected(false);
    ...
    private void switchForAction(ActionType action) {
        ...
        switch (action) {
            ...
            case LogAction:
                ...
                break;
            case ShieldtraAction:
                switchView(viewServers);
                tabBtnShieldtra.setSelected(true);
                break;
            case ConnectAction:
                switchView(viewServers);
        ...
        switch (rid) {
            ...
            case R.id.tabBtnSetting:
                if (ConfigManager.isLoginned)
                    ...
                    switchForAction(ActionType.SignInAction);
                break;
            case R.id.tabBtnShieldtra:
                if (ConfigManager.isLoginned)
                    switchForAction(ActionType.ShieldtraAction);
                else
                    switchForAction(ActionType.SignInAction);
                break;
