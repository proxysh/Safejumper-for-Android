...
public class SettingsAction implements OnCheckedChangeListener, OnClickListener {
	...
	private UpdateHubTask asyncTask = null;
	...
	public void onCheckedChanged(CompoundButton v, boolean checked) {
		...
		case R.id.checkAllDisplay:
			...
			asyncTask = new UpdateHubTask();
			asyncTask.execute(ConfigManager.activeUserName, ConfigManager.activePasswdOfUser, checked);
			break;
		default:
			break;
		}
	...
	private class UpdateHubTask extends AsyncTask<Object, Void, Boolean> {
		...
		protected Boolean doInBackground(Object... params) {
			...
			boolean enableAllLocation = (Boolean) params[2];
